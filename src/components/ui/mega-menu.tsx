...
const MegaMenu: React.FC<MegaMenuProps> = ({ columns }) => {
  return (
    <div className='megaMenu shadow-header bg-gray-200 absolute left-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible'>
              ...
              <React.Fragment key={columnItem.id}>
                <li className='mb-1.5'>
                  <Link
                    ...
                    className='block text-sm py-1.5 text-heading font-semibold px-6 2xl:px-10 hover:text-heading hover:bg-gray-300'
                  >
                    {columnItem.label}
                  </Link>
                </li>
                {columnItem?.columnItemItems?.map((item: any) => (
                  ...
                  >
                    <Link
                      href={item.path}
                      className='text-body text-sm block py-1.5 px-6 2xl:px-10 hover:text-heading hover:bg-gray-300'
                    >
                      {item.label}
                    </Link>
                  </li>
